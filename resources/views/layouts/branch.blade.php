                            ...
                            <ul id="mainmenu">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{ url('/library') }}">Community Library</a></li>                                    </ul>
                                </li>
                    ...
                    <div class="row gy-4 gx-5 align-items-center">
                        ...
                        @php
                            $techQuotes = [
                                ...
                                "Simple tech beats clever tech.",
                                "Power lies in useful technology.",
                                "The best technology disappears.",
                                "Tools shape how we think.",
                                "Innovation is clarity, not complexity.",
                                "Good technology feels invisible.",
                                "Machines work best when humans think.",
                                "Technology should make life lighter.",
                            ];
